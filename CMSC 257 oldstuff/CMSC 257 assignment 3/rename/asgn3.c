...
/***********************************************************************************
**
**   check_memory() checks the memory at the top of the heap. 
**
**  Inputs	- NONE
...
/***********************************************************************************
** 
**  Print() prints out address, start and end 
**
...
/***********************************************************************************
**
**  memoryleak() prints the memory leaks for each allocation
**
**  Inputs - void *ptr
**  Outputs - print statement
**
...
/***********************************************************************************
** 
** main() is the main function for the assign3 program. 
**
**  Inputs - none
**  Outputs - return either 1 (success) or -1 (failure)
** 
************************************************************************************/

int main( ) {

//Call malloc(), calloc(), realloc() and free() at least 10 times
...
// Using the new malloc to allocate memory with the ability to merge and split.
